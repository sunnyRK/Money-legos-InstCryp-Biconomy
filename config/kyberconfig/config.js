...
// export const HTTP_PROVID ER = 'https://ropsten.infura.io/v3/37bd907f93a146679960d54e729cd51a';
// export const web3 = new Web3(new Web3.providers.HttpProvider(HTTP_PROVIDER));
...
// export const KYBER_NETWORK_PROXY_ADDRESS = "0x818e6fecd516ecc3849daf6845e3ec868087b755"; // Ropsten
...
export function convertInWei(tokenQty, tokenDecimal) {
  return (tokenQty * 10 ** tokenDecimal).toString();
}

// Wallet Address for Fee Sharing Program 
//If none, set to 0x0000000000000000000000000000000000000000 (null address)
export const REF_ADDRESS = "0x48845392F5a7c6b360A733e0ABE2EdcC74f1F4d6";
//const REF_ADDRESS = "0x0000000000000000000000000000000000000000"

// Get the contract instances
export const KYBER_NETWORK_PROXY_CONTRACT = new web3Biconomy.eth.Contract(
  KYBER_NETWORK_PROXY_ABI,
  KYBER_NETWORK_PROXY_ADDRESS
);

export function getSrcTokenContract(SRC_TOKEN_ADDRESS) {
  return new web3Biconomy.eth.Contract(ERC20_ABI, SRC_TOKEN_ADDRESS);
}

// export const SRC_TOKEN_CONTRACT = new web3.eth.Contract(ERC20_ABI, SRC_TOKEN_ADDRESS);
